function BattleSection({ stage, bossHP, maxHP, crop, onTap, timerPercent = 100, hpTrailPercent = 100 }) {
  ...
  return (
    <section className="wf-main wf-battle-scene" aria-label="Main gameplay">
      <button
        ...
        onClick={onTap}
      >
        <img className="wf-crop-image" src={cropImage} alt={cropName} />
      </button>
        ...
        <div className="wf-hp-group">
          ...
          <div className="wf-bar-shell">
            <div className="wf-bar hp">
              <div className="wf-bar-fill hp-trail" style={{ width: `${hpTrailPercent}%` }} />
              <div className="wf-bar-fill hp" style={{ width: `${hpPercent}%` }} />
            </div>

            {isBossStage ? (
              <div className="wf-bar timer">
                <div className="wf-bar-fill timer" style={{ width: `${timerPercent}%` }} />
              </div>
            ) : null}
          </div>
        </div>
